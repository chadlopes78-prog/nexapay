...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "CheckoutPro Mozambique | SaaS de Checkout" },
      { property: "og:description", content: "A plataforma de checkout mais completa para Moçambique. Aceite M-Pesa e e-Mola." },

      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "CheckoutPro Mozambique | SaaS de Checkout" },
      { name: "twitter:description", content: "A plataforma de checkout mais completa para Moçambique. Aceite M-Pesa e e-Mola." },
